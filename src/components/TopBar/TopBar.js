...
const TopBar = ({ MessageFriend, friendData, activeUsers, messageConversation }) => {
  ...
  return (
    ...
    <div className="row topBar p-2">
      ...
      <div className='pt-2 mr-2' style={{ justifyContent: "end", display: "flex", position: "absolute" }}>
        <Dropdown>
